...
//would probably needed to be reduced to -1
#define CHECK_INT_MIN_MAX_ERROR 1
#define CHECK_UINT_MIN_MAX_ERROR 1
#define MULTIPLICATION_ZERO_ERROR 1
#define DIVISION_ZERO_ERROR 1
#define ADDITION_ERROR 1
#define SUBTRACTION_ERROR 1
#define MULTIPLICATION_ERROR 1
#define DIVISION_ERROR 1
#define SHIFT_ERROR 1
#define ROTATE_LEFT_ERROR 1
#define ROTATE_RIGHT_ERROR 1
#define MODULO_ERROR 1
#define INVALID_OPERATOR_ERROR 1
